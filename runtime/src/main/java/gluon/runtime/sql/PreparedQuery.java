...
public class PreparedQuery<T> implements AutoCloseable {
    ...
    StatementPreparator preparator;

    public PreparedQuery(Connection connection, String sql, ResultSetExtractor<T> resultSetExtractor, StatementPreparator preparator) throws SQLException {
        assert sql != null : "SQL must not be null";
        assert resultSetExtractor != null : "ResultSetExtractor  must not be null";
